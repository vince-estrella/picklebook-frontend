    ...
    <div className="w-full min-h-screen bg-slate-50 flex">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="px-12 py-4 bg-slate-50/80 shadow-sm backdrop-blur-md flex justify-between items-center sticky top-0 z-10">
          <h1 className="text-green-800 text-2xl font-bold leading-8">Revenue Reports</h1>
          <div className="flex items-center gap-3">
            <select
              value={range}
              onChange={e => setRange(e.target.value)}
              className="px-4 py-2 bg-gray-100 rounded-full text-sm font-medium text-slate-800 outline-none transition-shadow duration-150 focus:ring-2 focus:ring-green-700/30"
            >
              {RANGE_OPTIONS.map(o => (
            ...
            <button
              ...
              className="px-5 py-2 bg-green-800 hover:bg-green-900 active:scale-95 rounded-full flex items-center gap-2 text-white text-sm font-medium transition-all duration-150"
            >
          ...
          <div className="grid grid-cols-4 gap-4">
            <div className="p-6 bg-zinc-800 rounded-xl flex flex-col justify-between transition-shadow duration-150 hover:shadow-lg">
              ...
              <div className="pt-8 flex flex-col gap-1">
                <span className="opacity-80 text-zinc-200 text-xs font-medium uppercase leading-4 tracking-wide">Total Revenue</span>
                <span className="text-white text-3xl font-bold leading-10">{formatCurrency(totalRevenue)}</span>
              </div>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl outline outline-1 outline-offset-[-1px] outline-stone-300 flex flex-col justify-between transition-shadow duration-150 hover:shadow-md">
              ...
              <div className="pt-8 flex flex-col gap-1">
                <span className="text-slate-500 text-xs font-medium uppercase leading-4 tracking-wide">Total Bookings</span>
                <span className="text-slate-800 text-3xl font-bold leading-10">{totalBookings}</span>
              </div>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl outline outline-1 outline-offset-[-1px] outline-stone-300 flex flex-col justify-between transition-shadow duration-150 hover:shadow-md">
              ...
              <div className="pt-8 flex flex-col gap-1">
                <span className="text-slate-500 text-xs font-medium uppercase leading-4 tracking-wide">Avg. Booking Value</span>
                <span className="text-slate-800 text-3xl font-bold leading-10">{formatCurrency(avgBookingValue)}</span>
              </div>
            </div>
            ...
            <div className="p-6 bg-white rounded-xl outline outline-1 outline-offset-[-1px] outline-stone-300 flex flex-col justify-between transition-shadow duration-150 hover:shadow-md">
              ...
              <div className="pt-8 flex flex-col gap-1">
                <span className="text-slate-500 text-xs font-medium uppercase leading-4 tracking-wide">Top Performing Court</span>
                <span className="text-slate-800 text-xl font-bold leading-8 truncate">
          ...
          <div className="grid grid-cols-3 gap-8 items-start">
            ...
            <div className="col-span-2 flex flex-col gap-4">
              <div className="px-1 flex justify-between items-center">
                <h2 className="text-slate-800 text-2xl font-semibold leading-8">Revenue by Court</h2>
              </div>
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr className="bg-gray-100 border-b border-stone-300">
                      <th className="px-6 py-4 text-left text-slate-500 text-sm font-semibold uppercase leading-4 tracking-wide">Court</th>
                      <th className="px-6 py-4 text-left text-slate-500 text-sm font-semibold uppercase leading-4 tracking-wide">Bookings</th>
                      <th className="px-6 py-4 text-left text-slate-500 text-sm font-semibold uppercase leading-4 tracking-wide">Revenue</th>
                      <th className="px-6 py-4 text-left text-slate-500 text-sm font-semibold uppercase leading-4 tracking-wide">Share</th>
                    </tr>
                  </thead>
                  <tbody>
                        ...
                        return (
                          <tr key={c.name} className="border-t border-stone-200 transition-colors duration-150 hover:bg-gray-200">
                            <td className="px-6 py-4">
                              <p className="text-slate-800 text-base font-normal leading-6">{c.name}</p>
